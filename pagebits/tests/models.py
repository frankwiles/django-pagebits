...
class PageBitModelTests(TestCase):
    ...
    def test_uniqueness(self):
        ...
        PageBit.objects.create(name='header', context_name='header', type=0, group=group2)

    def test_signals_work(self):
        group1 = BitGroup.objects.create(name='TestGroup1')
        bit1 = PageBit.objects.create(name='header', context_name='header', type=0, group=group1)
        bit2 = PageBit.objects.create(name='header2', context_name='header2', type=0, group=group1)
